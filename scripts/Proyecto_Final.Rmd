...
Entre estas 6 variables existen varias relaciones importantes, empezando primero por la variable C, que corresponde a la composición del cóctel, esta variable afecta la concentración final de ambos compuestos Aceto e Ibu, ya que la concentración alta o baja de los fármacos, va a influir la concentración final después de la degradación. Y también la composición del cóctel afecta la toxicidad (UT) resultante, ya que algunos tratamientos por sí solos pueden ser mas tóxicos que otros, sin contar todavía la degradación de los hongos. Seguidamente, la variable H, que representa la identidad de los cultivos de hongos, va a afectar directamente las concentraciones finales de Ibu (E) y Aceto (J), ya que existen algunos hongos que logran degradar más unos compuestos sobre otros. A su vez, esta variable también afecta la toxicidad (UT), ya que algunos hongos pueden producir intermediarios tóxicos que afecten el valor de UT, sin degradar los compuestos. 
